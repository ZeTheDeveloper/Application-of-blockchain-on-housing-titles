...
presetup() {
    ...
    pushd ./artifacts/src/github.com/housingtitle/go
...
VERSION="1"
CC_SRC_PATH="./artifacts/src/github.com/housingtitle/go"
CC_NAME="housingtitle"
...
installChaincode() {
    setGlobalsForPeer0Org1 # endorsing peer of org1
    ...
    setGlobalsForPeer0Org2 # endorsing peer of Org2
    peer lifecycle chaincode install ${CC_NAME}.tar.gz
...
chaincodeQuery() {
    ...
    # Query Car by Id
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "GetAllAssets","Args":["Asset1"]}'
