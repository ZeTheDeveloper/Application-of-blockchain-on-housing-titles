createcertificatesForOrg1() {
  ...
  #Put these files in config.yaml of msp org1, consist of policies
  #Client, peer, admin has their own certificate, for example, admin certificate allows admin to perform admin transactions
  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
